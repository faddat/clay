...
var (
	DefaultCLIHome = os.ExpandEnv("$HOME/.claycli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.clayd")
...
func NewInitApp(
	...
	app.clayKeeper = claykeeper.NewKeeper(
		app.bankKeeper,
		app.cdc,
		keys[claytypes.StoreKey],
	)
